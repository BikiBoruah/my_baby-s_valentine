...
function drawText() {
    ...
    if(frameNumber >= 2250 && frameNumber < 2500){
        ...
        if (window.innerWidth < 600) {
            drawTextWithLineBreaks(["and yet here I am to get the impossible", "chance to get to know you",",for which I thank GOD"], canvas.width / 2, canvas.height / 2, fontSize, lineHeight);
        } else {
            context.fillText("and yet here I am to get the impossible chance to get to know you, for which I thank GOD", canvas.width/2, canvas.height/2);
        }
    ...
    if(frameNumber > 2500 && frameNumber < 99999){
        ...
        if (window.innerWidth < 600) {
            drawTextWithLineBreaks(["I love you so much my baby, EBOTI, more than", "all the time and space in the universe can contain"], canvas.width / 2, canvas.height / 2, fontSize, lineHeight);
        } else {
            context.fillText("I love you so much my baby, EBOTI, more than all the time and space in the universe can contain", canvas.width/2, canvas.height/2);
        }
    ...
    if(frameNumber >= 3000 && frameNumber < 99999){
        ...
        context.fillText("Happy Valentine's Week <3", canvas.width/2, (canvas.height/2 + 120));
